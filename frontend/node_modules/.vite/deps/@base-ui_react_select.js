...
import {
  ...
  visuallyHidden,
  visuallyHiddenInput
} from "./chunk-OONV2TFD.js";
import {
  useButton
} from "./chunk-PUJHWNNX.js";
import {
  clamp,
  contains,
...
function SelectRoot(props) {
  ...
  const listRef = React4.useRef([]);
  const labelsRef = React4.useRef([]);
  const popupRef = React4.useRef(null);
  const scrollHandlerRef = React4.useRef(null);
  const scrollArrowsMountedCountRef = React4.useRef(0);
  const valueRef = React4.useRef(null);
  const valuesRef = React4.useRef([]);
  const typingRef = React4.useRef(false);
  const firstItemTextRef = React4.useRef(null);
  const selectedItemTextRef = React4.useRef(null);
  const selectionRef = React4.useRef({
    allowSelectedMouseUp: false,
    allowUnselectedMouseUp: false,
    dragY: 0
  });
  const alignItemWithTriggerActiveRef = React4.useRef(false);
  const {
    mounted,
    setMounted,
    transitionStatus
  ...
  const serializedValue = React4.useMemo(() => {
    if (multiple) {
      return "";
    }
    return stringifyAsValue(value, itemToStringValue);
  }, [multiple, value, itemToStringValue]);
  const fieldStringValue = React4.useMemo(() => {
    if (multiple && Array.isArray(value)) {
  ...
  const initialValueRef = React4.useRef(value);
  ...
  const mergedTriggerProps = React4.useMemo(() => {
  ...
  const popupProps = React4.useMemo(() => mergeProps(FOCUSABLE_POPUP_PROPS, typeahead.floating, listNavigation.floating, dismiss.floating), [typeahead.floating, listNavigation.floating, dismiss.floating]);
  ...
  const hiddenInputs = React4.useMemo(() => {
...
// node_modules/@base-ui/react/select/label/SelectLabel.mjs
var SelectLabel = React5.forwardRef(function SelectLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectTrigger = React6.forwardRef(function SelectTrigger2(componentProps, forwardedRef) {
  ...
  const mergedProps = mergeProps(triggerProps, {
    ...
    "aria-controls": open ? (listElement == null ? void 0 : listElement.id) ?? ((_a = getFloatingFocusElement(positionerElement)) == null ? void 0 : _a.id) : void 0,
...
var CompositeListContext = React12.createContext({
  register: () => {
  },
  unregister: () => {
  },
...
function useCompositeListContext() {
  return React12.useContext(CompositeListContext);
}
...
function CompositeList(props) {
  ...
  const nextIndexRef = React13.useRef(0);
  const listeners = useRefWithInit(createListeners).current;
  const map = useRefWithInit(createMap).current;
  const [mapTick, setMapTick] = React13.useState(0);
  const lastTickRef = React13.useRef(mapTick);
  ...
  const sortedMap = React13.useMemo(() => {
  ...
  return (0, import_jsx_runtime4.jsx)(CompositeListContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useDirection() {
  const context = React14.useContext(DirectionContext);
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React15.useState(null);
  ...
  const autoUpdateOptions = React15.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React15.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
  ...
  const arrowStyles = React15.useMemo(() => {
    var _a2, _b2;
    return {
      position: "absolute",
...
var SelectPositionerContext = React16.createContext(void 0);
if (true) SelectPositionerContext.displayName = "SelectPositionerContext";
function useSelectPositionerContext() {
  const context = React16.useContext(SelectPositionerContext);
  if (!context) {
...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React17.useState(false);
  useIsoLayoutEffect(() => {
...
var SelectPositioner = React18.forwardRef(function SelectPositioner2(componentProps, forwardedRef) {
  const {
    anchor,
    positionMethod = "absolute",
    className,
  ...
  const transitionStatus = useStore(store, selectors.transitionStatus);
  const scrollUpArrowRef = React18.useRef(null);
  const scrollDownArrowRef = React18.useRef(null);
  const [controlledAlignItemWithTrigger, setControlledAlignItemWithTrigger] = React18.useState(alignItemWithTrigger);
  ...
  React18.useImperativeHandle(alignItemWithTriggerActiveRef, () => alignItemWithTriggerActive);
  ...
  const prevMapSizeRef = React18.useRef(0);
  ...
  return (0, import_jsx_runtime5.jsx)(CompositeList, {
    elementsRef: listRef,
    labelsRef,
    onMapChange,
    children: (0, import_jsx_runtime5.jsxs)(SelectPositionerContext.Provider, {
      value: contextValue,
      children: [mounted && modal && (0, import_jsx_runtime5.jsx)(InternalBackdrop, {
...
var ToolbarRootContext = React19.createContext(void 0);
if (true) ToolbarRootContext.displayName = "ToolbarRootContext";
function useToolbarRootContext(optional) {
  const context = React19.useContext(ToolbarRootContext);
...
var CSPContext = React20.createContext(void 0);
...
var SelectPopup = React21.forwardRef(function SelectPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const positionerElement = useStore(store, selectors.positionerElement);
  const listElement = useStore(store, selectors.listElement);
  const reachedMaxHeightRef = React21.useRef(false);
  const initialPlacedRef = React21.useRef(false);
  const originalPositionerStylesRef = React21.useRef({});
  ...
  React21.useImperativeHandle(scrollHandlerRef, () => handleScroll, [handleScroll]);
  useOpenChangeComplete({
    open,
    ref: popupRef,
    onComplete() {
  ...
  useIsoLayoutEffect(() => {
    ...
    try {
      ...
      if (!(textElement == null ? void 0 : textElement.isConnected)) {
        const hasSelectedValue = selectors.hasSelectedValue(store.state);
        textElement = !hasSelectedValue && ((_a = firstItemTextRef.current) == null ? void 0 : _a.isConnected) ? firstItemTextRef.current : null;
      }
      ...
      const isPinchZoomed = (((_b = win.visualViewport) == null ? void 0 : _b.scale) ?? 1) !== 1 && parts_exports.engine.webkit;
  ...
  return (0, import_jsx_runtime7.jsxs)(React21.Fragment, {
    children: [!disableStyleElements && styleDisableScrollbar.getElement(nonce), (0, import_jsx_runtime7.jsx)(FloatingFocusManager, {
...
var SelectList = React22.forwardRef(function SelectList2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
function useCompositeListItem(params = {}) {
  ...
  const [index, setIndex] = React23.useState(externalIndex ?? (indexGuessBehavior === IndexGuessBehavior.GuessFromOrder ? () => {
...
var SelectItemContext = React24.createContext(void 0);
if (true) SelectItemContext.displayName = "SelectItemContext";
function useSelectItemContext() {
  const context = React24.useContext(SelectItemContext);
  if (!context) {
...
var SelectItem = React25.memo(React25.forwardRef(function SelectItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const lastKeyRef = React25.useRef(null);
  const pointerTypeRef = React25.useRef("mouse");
  const allowMouseSelectionRef = React25.useRef(false);
  const {
    getButtonProps,
    buttonRef
  } = useButton({
  ...
  return (0, import_jsx_runtime8.jsx)(SelectItemContext.Provider, {
    value: contextValue,
    children: element
  });
}));
...
var SelectItemIndicator = React26.forwardRef(function SelectItemIndicator2(componentProps, forwardedRef) {
  ...
  return (0, import_jsx_runtime9.jsx)(Inner, {
    ...componentProps,
    ref: forwardedRef
  });
});
if (true) SelectItemIndicator.displayName = "SelectItemIndicator";
var Inner = React26.memo(React26.forwardRef((componentProps, forwardedRef) => {
  const {
    render,
    className,
    style,
...
var SelectItemText = React27.memo(React27.forwardRef(function SelectItemText2(componentProps, forwardedRef) {
  const {
    index,
    textRef,
    selectedByFocus,
  ...
  const localRef = React27.useCallback((node) => {
    if (!node) {
      return;
    }
...
var SelectArrow = React28.forwardRef(function SelectArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectScrollArrow = React29.forwardRef(function SelectScrollArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectScrollDownArrow = React30.forwardRef(function SelectScrollDownArrow2(props, forwardedRef) {
...
var SelectScrollUpArrow = React31.forwardRef(function SelectScrollUpArrow2(props, forwardedRef) {
  return (0, import_jsx_runtime11.jsx)(SelectScrollArrow, {
    ...props,
    ref: forwardedRef,
    direction: "up"
  });
...
var SelectGroupContext = React32.createContext(void 0);
if (true) SelectGroupContext.displayName = "SelectGroupContext";
function useSelectGroupContext() {
  const context = React32.useContext(SelectGroupContext);
  if (context === void 0) {
...
var SelectGroup = React33.forwardRef(function SelectGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  return (0, import_jsx_runtime12.jsx)(SelectGroupContext.Provider, {
    value: contextValue,
    children: element
  });
});
...
var SelectGroupLabel = React34.forwardRef(function SelectGroupLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var Separator = React35.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
