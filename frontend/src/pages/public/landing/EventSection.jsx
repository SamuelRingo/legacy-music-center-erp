          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {events.map((event) => (
              <Card 
                ...
                className="bg-zinc-950 border-zinc-800 overflow-hidden hover:border-gold-500/50 hover:shadow-lg hover:shadow-gold-500/20 transition-all group cursor-pointer outline-none focus:outline-none focus:ring-0 focus-visible:ring-0 ring-0 ring-offset-0"
