        ...
        <div className="relative z-10 max-w-md w-full bg-white/10 dark:bg-zinc-900/50 backdrop-blur-xl border border-white/20 dark:border-zinc-800/50 rounded-3xl shadow-2xl p-8 sm:p-12 text-center animate-in zoom-in-95 duration-500">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 backdrop-blur-sm">
            <p className="text-zinc-400 text-sm mb-2">
              Silakan hubungi WhatsApp kami untuk konsultasi kelas dan aktivasi akun:
            </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-1 gap-5">
          <div className="space-y-2 group">
            <Label htmlFor="name" className="text-zinc-700 dark:text-zinc-300 font-medium">Nama Lengkap</Label>
          ...
          <div className="space-y-2 group">
            <Label htmlFor="parentPhone" className="text-zinc-700 dark:text-zinc-300 font-medium">No. HP Orang Tua (WhatsApp)</Label>
          ...
          <div className="space-y-2 group">
            <Label htmlFor="address" className="text-zinc-700 dark:text-zinc-300 font-medium">Alamat</Label>
