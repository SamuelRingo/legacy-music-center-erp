        ...
        <div className="divide-y divide-zinc-200 dark:divide-zinc-800">
          {Array.from({ length: rows }).map((_, i) => (
            <div key={i} className="p-4 flex items-center gap-4">
              <div className="h-4 bg-zinc-200 dark:bg-zinc-700 rounded-md w-1/3 animate-pulse"></div>
              <div className="h-4 bg-zinc-200 dark:bg-zinc-700 rounded-md w-1/4 animate-pulse"></div>
              <div className="h-4 bg-zinc-200 dark:bg-zinc-700 rounded-md w-1/6 animate-pulse ml-auto"></div>
            </div>
          ))}
        </div>
      </div>
