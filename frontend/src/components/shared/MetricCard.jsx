...
export default function MetricCard({ title, value, subtitle, icon: Icon, variant = 'info' }) {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 shadow-sm p-5 print:p-2 outline-none ring-0 focus:outline-none focus:ring-0">
      <div className={`w-10 h-10 print:w-7 print:h-7 rounded-lg flex items-center justify-center ${style.bg} ${style.text}`}>
